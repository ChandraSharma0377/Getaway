...
//||selectedcdd.getAdminApproval().equalsIgnoreCase("Awaiting Payment")
        ...
        btn_reject.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedcdd != null) {
                    if (!selectedcdd.getAdminApproval().equalsIgnoreCase("Booked")) {
                        ...
                        ShowAlertInformation.showDialog(getActivity(), "Error", "Confirm booking is not allow to reject.");
                    }
                } else {
